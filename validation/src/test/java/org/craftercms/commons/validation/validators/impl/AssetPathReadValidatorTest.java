...
import static org.craftercms.commons.validation.annotations.param.EsapiValidationType.ASSET_PATH_READ;

public class AssetPathReadValidatorTest implements ValidatorTest {

    private Validator validator;

    @Before
    public void setUp() {
        validator = new EsapiValidator(ASSET_PATH_READ);
    }

    @Test
    public void testSpace() {
        assertValid("static-assets/folder 1/template.xml");
    }
