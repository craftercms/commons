...
/**
 * Simple extension of {@link org.springframework.web.client.RestTemplate} that sets the same message converters
 * in a {@link org.craftercms.commons.rest.HttpMessageConvertingResponseErrorHandler} if its message converters
 * are null.
 *
 * @author avasquez
 */
